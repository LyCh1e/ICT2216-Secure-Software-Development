  ...
  return (
    <div className="tg-root" data-variant="editorial">
      ...
      <section style={{ padding: 'calc(var(--tg-pad-y) * 0.9) var(--tg-pad-x) var(--tg-pad-y)' }}>
        <div className="tg-grid-hero">
          <div>
            ...
            <div className="tg-hero-cta" style={{ display: 'flex', gap: 12, marginTop: 32, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <div className="tg-hero-stats" style={{ marginTop: 36, display: 'flex', gap: 28, flexWrap: 'wrap', alignItems: 'center', color: 'var(--ink-3)', fontSize: 13 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div className="tg-card tg-hero-float" style={{ position: 'absolute', left: -40, bottom: 30, maxWidth: 280, padding: 18, boxShadow: '0 18px 40px -16px rgba(28,24,20,0.25)' }}>
      ...
      <section style={{ padding: 'var(--tg-pad-y) var(--tg-pad-x)', background: 'var(--cream-2)' }}>
        <div className="tg-story-block" style={{ maxWidth: 880 }}>
        ...
        <div className="tg-grid-stats" style={{ marginTop: 56 }}>
          {TG_STATS.map((s, i) => (
      ...
      <section id="how" style={{ padding: 'var(--tg-pad-y) var(--tg-pad-x)' }}>
        <div className="tg-grid-sidebar">
          ...
          <div>
            {TG_STEPS.map((step, i) => (
              <div key={i} className="tg-grid-step" style={{ padding: '28px 0', borderTop: '1px solid var(--line)' }}>
      ...
      <section style={{ padding: 'var(--tg-pad-y) var(--tg-pad-x)' }}>
        <div className="tg-grid-content">
          ...
          <div>
            ...
            <div className="tg-grid-features">
              {[
      ...
      {/* QUOTES */}
      <section className="tg-quotes-section" style={{ padding: 'var(--tg-pad-y) var(--tg-pad-x)', background: 'var(--ink)', color: 'var(--cream)' }}>
        <span className="tg-eyebrow" style={{ color: 'var(--cream-3)' }}><span className="dot"></span>In their words</span>
        <div className="tg-grid-quotes" style={{ marginTop: 24 }}>
          {TG_QUOTES.map((q, i) => (
